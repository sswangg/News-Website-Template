...
<head>
  ...
  <script>
    $(function(){
      $("#main-nav").load("header.html"); 
      $("#footie").load("footer.html"); 
    })  
  </script>


  <title>OctoTalk | Credible Social Media</title>
</head>
<body>
    ...
    <div class="container">
      <div class="showcase-container">
        <div class="showcase-content">
          <div class="category category-eng">
            Engineering
          </div>
          <h1>Engineering Article</h1>
    ...
    <div class="container">
      <div class="articles-container">
        ...
        <article class="card">     
          ...
          <div class="category category-tec">
            Technology
          </div>
          <h3>
            <a href="article.html">Lorem ipsum dolor sit amet.</a>
        ...
        <article class="card">     
          ...
          <div class="category category-lan">
            Language
        ...
        <article class="card">     
          ...
          <div class="category category-sci">
            Science
          </div>
          <h3>
            <a href="article.html">Lorem ipsum dolor sit amet.</a>
          ...
          <article class="card bg-primary">     
            <div class="category category-bus">
              Business
            </div>
            <h3>
              <a href="article.html">Lorem ipsum dolor sit amet.</a>
          ...
          <article class="card">
            <div>
              <div class="category category-fa">
                Fine Arts
              </div>
              <h3>
                <a href="article.html">Lorem ipsum dolor sit amet.</a>
